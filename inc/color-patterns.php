 ...
 */
function guoyunhe2_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Guo Yunhe 2 default saturation level.
	 *
	 * @since Guo Yunhe 2 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'guoyunhe2_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.guoyunhe2-front-page) .entry-title,
...
.colors-custom .guoyunhe2-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.guoyunhe2-front-page .panel-content .recent-posts article,
...
.colors-custom.guoyunhe2-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Guo Yunhe 2 custom colors CSS.
	 *
	 * @since Guo Yunhe 2 1.0
	 *
	 ...
	 */
	return apply_filters( 'guoyunhe2_custom_colors_css', $css, $hue, $saturation );
}
