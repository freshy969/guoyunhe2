...
function guoyunhe2_upgrade_notice() {
	$message = sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'guoyunhe2' ), $GLOBALS['wp_version'] );
...
function guoyunhe2_customize() {
	wp_die( sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'guoyunhe2' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function guoyunhe2_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'guoyunhe2' ), $GLOBALS['wp_version'] ) );
	}
}
